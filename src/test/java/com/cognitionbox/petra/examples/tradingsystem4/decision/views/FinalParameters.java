...
import com.cognitionbox.petra.examples.tradingsystem4.decision.enums.PInstrument;
...
@Primative
public class FinalParameters implements StrategyPreparedView, Serializable {
    private PInstrument instrument = new PInstrument();
    @Override
    public PInstrument instrument() {
        return instrument;
    }
}
