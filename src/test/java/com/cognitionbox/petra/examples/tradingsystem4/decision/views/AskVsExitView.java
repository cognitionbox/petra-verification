...
@Primative
public interface AskVsExitView {
    StrategyState strategyState();
    default boolean askBelowExit(){return strategyState().ask().lt(strategyState().exit());}
    default boolean askAboveExit(){return strategyState().ask().gt(strategyState().exit());}
}
