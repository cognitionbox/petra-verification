...
public final class State {
    ...
    public State product(State s){
        return new State(Sets.cartesianProduct(this.disjuncts,s.disjuncts).stream().map(c->and(c)).collect(Collectors.toSet()));
    }
    public SAbs abs(State s, Predicate<State>... via){
        return new SAbs(this,s,via);
    }
